...
public class PersonTests
{
    ...
    public void Test_GetByAgeAscending_SortsPeopleByAge()
    {
        ...
        var expected = $"Bob with ID: B002 is 30 years old.{Environment.NewLine}" +
                       $"Alice with ID: A001 is 35 years old.";


        string resultPeopleList = this._person.GetByAgeAscending(inputList);

        Assert.That(expected, Is.EqualTo(resultPeopleList));
